...
class TestEndToEndTranslation:
    ...
    def test_excel_translation_workflow(self, temp_dir, file_generator, mock_translator):
    ...
    def test_word_translation_workflow(self, temp_dir, file_generator, mock_translator):
        ...
        processor = get_processor_by_extension(str(input_file), translator=mock_translator)
    ...
    def test_powerpoint_translation_workflow(self, temp_dir, file_generator, mock_translator):
    ...
    def test_pdf_translation_workflow(self, temp_dir, mock_translator):
        ...
        # Get PDF processor
        try:
            processor = get_processor_by_extension("test.pdf", translator=mock_translator)
...
class TestTranslatorIntegration:
    ...
    def test_config_integration(self, test_config):
        ...
        try:
            ...
            assert processor.preserve_formatting == test_config.processor.preserve_formatting
            
            # Test that translator gets config
            assert processor.translator.max_workers == test_config.translator.max_workers
