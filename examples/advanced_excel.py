...
def advanced_excel_with_images():
    ...
    if not os.path.exists(input_file):
        ...
        print(
            "   Create an Excel file with Chinese text and images to test this feature"
        )
    ...
    try:
        ...
        if success:
            ...
            print(
                f"   Successful translations: {translator_stats['successful_translations']}"
            )
...
def excel_translation_different_languages():
    ...
    languages = {"en": "English", "th": "Thai", "ja": "Japanese", "fr": "French"}
    ...
    for lang_code, lang_name in languages.items():
        ...
        translator = GoogleTranslator(
            source_lang="zh", target_lang=lang_code, use_free_api=True, max_workers=1
        )
...
def create_sample_excel_with_formatting(file_path: str):
    ...
    try:
        ...
        data = [
            ...
            (
                "Long Text",
                "This is a very long text content used to test automatic line wrapping and column width adjustment functionality. It contains multiple sentences and various Chinese characters.",
            ),
        ]
