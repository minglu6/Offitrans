...
class ExcelProcessor(BaseProcessor):
    ...
    def __init__(self, **kwargs):
        ...
        self.smart_column_width = getattr(self.config.processor, 'smart_column_width', True)
                ...
                for img_info in sheet_images:
                    try:
                        ...
                        if hasattr(img_obj, 'anchor') and img_obj.anchor:
                            ...
                            logger.debug(f"Successfully restored image in sheet {sheet_name}")
                        else:
                            logger.warning(f"Could not restore image in sheet {sheet_name}")
                    ...
                    for cell in row:
                        if cell.value and isinstance(cell.value, str) and cell.value.strip():
                            ...
                            if not cell.value.startswith('='):
                                ...
                                logger.debug(f"Extracted text from {sheet_name}!{cell.coordinate}: '{cell.value[:50]}...'")
    ...
    def _replace_text_with_format_and_images(self, 
                                           excel_path: str, 
                                           output_path: str,
    ...
    def _parse_rich_text_object(self, rich_text: CellRichText, coordinate: str) -> Dict[str, Any]:
        """
    ...
    def _apply_cell_format(self, cell, format_info: Dict[str, Any], target_language: str = "en") -> None:
        """
        ...
        try:
            ...
            if target_language == 'th' and format_info.get('font_name'):
                ...
                if not any(thai_font.lower() in original_font.lower() for thai_font in thai_fonts):
    ...
    def _apply_rich_text_format(self, cell, original_text: str, translated_text: str,
                               rich_text_info: Dict[str, Any], target_language: str = "en") -> None:
        """
    ...
    def _create_inline_font(self, font_info: Dict[str, Any], target_language: str = "en") -> InlineFont:
        """
