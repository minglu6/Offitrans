...
class BaseProcessor(ABC):
    ...
    def preprocess_texts(self, texts: List[str]) -> Tuple[List[str], Dict[str, Any]]:
        ...
        logger.info(f"Text preprocessing: {len(texts)} → {len(unique_texts)} unique translatable texts")
        
        return unique_texts, metadata
    
    def translate_texts(self, texts: List[str], target_language: str = "en") -> List[str]:
        """
    ...
    def postprocess_translations(self, 
