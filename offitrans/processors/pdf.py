...
class PDFProcessor(BaseProcessor):
                        ...
                        if page_text.strip():
                            ...
                            for para_idx, paragraph in enumerate(paragraphs):
                                if paragraph:
                                    ...
                                    logger.debug(f"Extracted text from page {page_num + 1}, paragraph {para_idx}: '{paragraph[:50]}...'")
    ...
    def translate_and_save(self, 
        ...
        try:
            ...
            success = self._save_translated_content(text_data, translated_texts, output_path)
    ...
    def _save_translated_content(self, 
...
def translate_pdf(input_path: str, output_path: str, target_language: str = "en") -> bool:
    """
