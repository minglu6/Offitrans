...
def validate_language_code(lang_code: str, supported_languages: Optional[Dict[str, str]] = None) -> bool:
    """
...
def split_text_chunks(text: str, max_chunk_size: int = 5000, overlap: int = 100) -> List[str]:
    """
